...
| Strona FAQ (`/faq/`, `/en/faq/`) | brak | nowa podstrona, 21 pytań w 7 sekcjach + dane strukturalne `FAQPage` | **zamówiona przez właściciela** pod GEO - krótkie pary pytanie–odpowiedź są łatwe do zacytowania przez ChatGPT i Perplexity. Treść dostarczona przez właściciela (realne pytania klientów), nie wymyślona. **UWAGA: blok `FAQPage` NIE da rozwijanych odpowiedzi w Google.** Google ograniczył tę funkcję we wrześniu 2023 do stron rządowych i zdrowotnych, a w maju 2026 **wycofał ją całkowicie** (dokumentację usunięto w czerwcu 2026). Potwierdzone testem Rich Results 2026-08-17: strona FAQ zwraca „nie wykryto żadnych elementów", podczas gdy strona główna zwraca 3 prawidłowe. Znacznik zostaje, bo jest poprawny wg schema.org i czytają go inne systemy (asystenci AI, Bing) - ale nie należy oczekiwać po nim efektu wizualnego w Google. Link **w stopce, nie w menu głównym** - nagłówek jest 1:1 z oryginałem i dołożenie tam pozycji zmieniłoby układ |
